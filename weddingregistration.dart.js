...
$$.WeddingState = {"":
 ["stateMap?", "restrictionState", "dietaryState", "completionState", "stateNum"],
 super: "Object",
 WeddingState$0: function() {
  this.stateMap = $.HashMapImplementation$();
  var t1 = this.stateMap;
  var t2 = this.stateNum;
  $.indexSet(t1, t2, $.RegState$(0, 'StartScreen', 'Press [ENTER]'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(0, 'Intro', 'Welcome to the LePosey registration system.'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(0, 'Flavor01', 'Presumably you\'ve been invited to our wedding. Correct?'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(2, '#memoryInpt', 'To prove it, what is your fondest memory of us?'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(2, '#nameInpt', 'OK, before we start, what is your name?'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(2, '#comingInpt', 'Are you coming to the wedding?'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(2, '#plus1Inpt', 'Are you bringing a plus 1?'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(2, '#plus1nameInpt', 'What is the name of your guest?'));
  this.stateNum = t2 + 1;
  this.dietaryState = t2 - 1;
  $.indexSet(t1, t2, $.RegState$(2, '#mainFoodInpt', 'Pick your meal type!'));
  this.stateNum = t2 + 1;
  $.indexSet(t1, t2, $.RegState$(2, '#guestFoodInpt', 'What\'s your guest\'s meal type?'));
  this.stateNum = t2 + 1;
  this.restrictionState = t2 - 1;
  $.indexSet(t1, t2, $.RegState$(2, '#restrictionInpt', 'Do you have any dietary restrictions?'));
  this.stateNum = t2 + 1;
  this.completionState = t2 - 1;
  $.indexSet(t1, t2, $.RegState$(2, '#submitInpt', 'Thank you for your RSVP. Click \'Submit\' to finish.'));
  this.stateNum = t2 + 1;
 }
};

$$.RegState = {"":
 ["textValue?", "name?", "sType?"],
 super: "Object"
};
...
$.WeddingState$ = function() {
  var t1 = new $.WeddingState(null, 0, 0, 0, 0);
  t1.WeddingState$0();
  return t1;
};
...
$.StateMachine = function(event$) {
  var textElement = $.query('#text');
  var t1 = event$.get$keyCode();
  if (typeof t1 !== 'number') return $.StateMachine$bailout(1, event$, textElement, t1, 0);
  if (t1 === 13) {
    t1 = $.counter;
    if (typeof t1 !== 'number') return $.StateMachine$bailout(2, event$, textElement, t1, 0);
    var t3 = $.stateNum;
    if (typeof t3 !== 'number') return $.StateMachine$bailout(3, event$, textElement, t1, t3);
    if (t1 < t3 - 1) {
      t1 = $.counter;
      if (typeof t1 !== 'number') return $.StateMachine$bailout(4, event$, textElement, t1, 0);
      $.counter = t1 + 1;
      t1 = $.state.get$stateMap();
      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(5, event$, textElement, t1, 0);
      t3 = $.counter;
      if (t3 !== (t3 | 0)) throw $.iae(t3);
      var t4 = t1.length;
      if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
      var t5 = t1[t3].get$sType();
      if (typeof t5 !== 'number') return $.StateMachine$bailout(6, event$, t5, textElement, 0);
      if (t5 === 0) {
        $.query('#nameInpt').set$hidden(true);
        $.query('#comingInpt').set$hidden(true);
        $.query('#plus1Inpt').set$hidden(true);
        $.query('#plus1nameInpt').set$hidden(true);
        $.query('#mainFoodInpt').set$hidden(true);
        $.query('#guestFoodInpt').set$hidden(true);
        $.query('#restrictionInpt').set$hidden(true);
        $.query('#memoryInpt').set$hidden(true);
        $.query('#submitInpt').set$hidden(true);
        t1 = $.state.get$stateMap();
        if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(7, t1, 0, 0, 0);
        t3 = $.counter;
        if (t3 !== (t3 | 0)) throw $.iae(t3);
        t4 = t1.length;
        if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
        t5 = t1[t3].get$name();
        if (typeof t5 !== 'string') return $.StateMachine$bailout(8, t5, 0, 0, 0);
        if (t5 === 'Intro') {
          $.query('#container').get$style().set$backgroundImage('Url(\'./Images/bg480.png\')');
          $.query('#oak').set$hidden(false);
          $.query('#speech-bubble').set$hidden(false);
        }
        $.isWriting = true;
        $.writingCounter = 0;
        $._TimerFactory_Timer($.writingSpeed, $.writeChar);
      } else {
        t1 = $.state.get$stateMap();
        if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(9, event$, t1, textElement, 0);
        t3 = $.counter;
        if (t3 !== (t3 | 0)) throw $.iae(t3);
        t4 = t1.length;
        if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
        t5 = t1[t3].get$sType();
        if (typeof t5 !== 'number') return $.StateMachine$bailout(10, event$, textElement, t5, 0);
        if (t5 === 1) {
          t1 = $.isWriting;
          if (typeof t1 !== 'boolean') return $.StateMachine$bailout(11, event$, t1, textElement, 0);
          if (t1) {
            $.isWriting = false;
            $.writingCounter = 2000;
            t1 = $.state.get$stateMap();
            if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(12, textElement, t1, 0, 0);
            t3 = $.counter;
            if (typeof t3 !== 'number') return $.StateMachine$bailout(13, textElement, t1, t3, 0);
            --t3;
            if (t3 !== (t3 | 0)) throw $.iae(t3);
            t5 = t1.length;
            if (t3 < 0 || t3 >= t5) throw $.ioore(t3);
            textElement.set$text(t1[t3].get$textValue());
          } else $.StateMachine(event$);
        } else {
          t1 = $.state.get$stateMap();
          if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(14, event$, t1, 0, 0);
          t3 = $.counter;
          if (t3 !== (t3 | 0)) throw $.iae(t3);
          t4 = t1.length;
          if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
          t5 = t1[t3].get$sType();
          if (typeof t5 !== 'number') return $.StateMachine$bailout(15, event$, t5, 0, 0);
          if (t5 === 2) {
            t1 = $.state.get$stateMap();
            if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(16, t1, 0, 0, 0);
            t3 = $.counter;
            if (t3 !== (t3 | 0)) throw $.iae(t3);
            t4 = t1.length;
            if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
            $.query(t1[t3].get$name()).set$hidden(false);
          } else {
            t1 = $.state.get$stateMap();
            if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(17, event$, t1, 0, 0);
            t3 = $.counter;
            if (t3 !== (t3 | 0)) throw $.iae(t3);
            t4 = t1.length;
            if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
            t5 = t1[t3].get$sType();
            if (typeof t5 !== 'number') return $.StateMachine$bailout(18, event$, t5, 0, 0);
            if (t5 === 3) {
              t1 = $.state.get$stateMap();
              if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(19, event$, t1, 0, 0);
              t3 = $.counter;
              if (t3 !== (t3 | 0)) throw $.iae(t3);
              t4 = t1.length;
              if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
              t5 = t1[t3].get$name();
              if (typeof t5 !== 'string') return $.StateMachine$bailout(20, event$, t5, 0, 0);
              if (!(t5 === 'EntryNameValidation')) {
                t1 = $.state.get$stateMap();
                if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(21, event$, t1, 0, 0);
                t3 = $.counter;
                if (t3 !== (t3 | 0)) throw $.iae(t3);
                t4 = t1.length;
                if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
                t5 = t1[t3].get$name();
                if (typeof t5 !== 'string') return $.StateMachine$bailout(22, event$, t5, 0, 0);
                t5 = t5 === 'GuestNameValidation';
                t1 = t5;
              } else t1 = true;
              if (t1) {
                ...
                t1 = $.state.get$stateMap();
                if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(23, event$, t1, fname, lname);
                t3 = $.counter;
                if (t3 !== (t3 | 0)) throw $.iae(t3);
                t4 = t1.length;
                if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
                t5 = t1[t3].get$name();
                if (typeof t5 !== 'string') return $.StateMachine$bailout(24, event$, fname, t5, lname);
                if (t5 === 'GuestNameQuestion') {
                  fname = $.query('Plus1FirstName');
                  lname = $.query('Plus1LastName');
                }
                t1 = fname.get$value();
                if (typeof t1 !== 'string') return $.StateMachine$bailout(25, event$, lname, t1, 0);
                if (t1 === '') var valPassed = false;
                else {
                  t1 = lname.get$value();
                  if (typeof t1 !== 'string') return $.StateMachine$bailout(26, event$, t1, 0, 0);
                  valPassed = !(t1 === '') || false;
                }
              } else {
                t1 = $.state.get$stateMap();
                if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(27, event$, t1, 0, 0);
                t3 = $.counter;
                if (t3 !== (t3 | 0)) throw $.iae(t3);
                t4 = t1.length;
                if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
                t5 = t1[t3].get$name();
                if (typeof t5 !== 'string') return $.StateMachine$bailout(28, event$, t5, 0, 0);
                if (t5 === 'EntryValQuestion') {
                  t1 = $.query('#Memory').get$value();
                  if (typeof t1 !== 'string') return $.StateMachine$bailout(29, event$, t1, 0, 0);
                  valPassed = !(t1 === '') || false;
                } else {
                  t1 = $.state.get$stateMap();
                  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(30, event$, t1, 0, 0);
                  t3 = $.counter;
                  if (t3 !== (t3 | 0)) throw $.iae(t3);
                  t4 = t1.length;
                  if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
                  t5 = t1[t3].get$name();
                  if (typeof t5 !== 'string') return $.StateMachine$bailout(31, event$, t5, 0, 0);
                  if (t5 === 'ComingValidation') {
                    t1 = $.query('#NoComing').get$checked();
                    if (typeof t1 !== 'boolean') return $.StateMachine$bailout(32, event$, t1, 0, 0);
                    if (t1) {
                      $.counter = $.completionState;
                      $.StateMachine(event$);
                    }
                  } else {
                    t1 = $.state.get$stateMap();
                    if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(33, event$, t1, 0, 0);
                    t3 = $.counter;
                    if (t3 !== (t3 | 0)) throw $.iae(t3);
                    t4 = t1.length;
                    if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
                    t5 = t1[t3].get$name();
                    if (typeof t5 !== 'string') return $.StateMachine$bailout(34, event$, t5, 0, 0);
                    if (t5 === 'Plus1Validation') {
                      t1 = $.query('#NoGuest').get$checked();
                      if (typeof t1 !== 'boolean') return $.StateMachine$bailout(35, event$, t1, 0, 0);
                      if (t1) {
                        $.counter = $.dietaryState;
                        $.StateMachine(event$);
                      }
                    } else {
                      t1 = $.state.get$stateMap();
                      if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.StateMachine$bailout(36, event$, t1, 0, 0);
                      t3 = $.counter;
                      if (t3 !== (t3 | 0)) throw $.iae(t3);
                      t4 = t1.length;
                      if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
                      t5 = t1[t3].get$name();
                      if (typeof t5 !== 'string') return $.StateMachine$bailout(37, event$, t5, 0, 0);
                      if (t5 === 'EntryDinnerValidation') {
                        t1 = $.query('#NoGuest').get$checked();
                        if (typeof t1 !== 'boolean') return $.StateMachine$bailout(38, event$, t1, 0, 0);
                        if (t1) {
                          $.counter = $.restrictionState;
                          $.StateMachine(event$);
                        }
                      }
                    }
              ...
              if (valPassed) $.StateMachine(event$);
              else {
                t1 = $.counter;
                if (typeof t1 !== 'number') return $.StateMachine$bailout(39, t1, 0, 0, 0);
                $.counter = t1 - 1;
              }
            }
          }
...
$.writeChar = function(t) {
  var t1 = $.state.get$stateMap();
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.writeChar$bailout(1, t1, 0, 0);
  var t3 = $.counter;
  if (t3 !== (t3 | 0)) throw $.iae(t3);
  var t4 = t1.length;
  if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
  var s = t1[t3].get$textValue();
  t1 = $.writingCounter;
  if (typeof t1 !== 'number') return $.writeChar$bailout(2, t1, s, 0);
  t3 = $.get$length(s);
  if (typeof t3 !== 'number') return $.writeChar$bailout(3, t1, t3, s);
  if (t1 < t3) {
    t1 = $.state.get$stateMap();
    if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || (t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))) return $.writeChar$bailout(4, t1, s, 0);
    t3 = $.counter;
    if (t3 !== (t3 | 0)) throw $.iae(t3);
    t4 = t1.length;
    if (t3 < 0 || t3 >= t4) throw $.ioore(t3);
    var t5 = t1[t3].get$sType();
    if (typeof t5 !== 'number') return $.writeChar$bailout(5, s, t5, 0);
    t5 = t5 === 0;
    t1 = t5;
  } else t1 = false;
  if (t1) {
    var textElement = $.query('#text');
    t1 = $.writingCounter;
    if (typeof t1 !== 'number') return $.writeChar$bailout(6, textElement, t1, s);
    textElement.set$text($.substring$2(s, 0, t1 + 1));
    t3 = $.writingCounter;
    if (typeof t3 !== 'number') return $.writeChar$bailout(7, t3, 0, 0);
    $.writingCounter = t3 + 1;
    $._TimerFactory_Timer($.writingSpeed, $.writeChar);
...
$.RegState$ = function(sType, name$, textValue) {
  return new $.RegState(textValue, name$, sType);
};
...
$._TimerFactory_Timer = function(milliSeconds, callback) {
  if ($._TimerFactory__factory == null) throw $.captureStackTrace($.UnsupportedOperationException$('Timer interface not supported.'));
...
$.main = function() {
  ...
  $.state = $.WeddingState$();
  $._TimerFactory_Timer($.writingSpeed, $.writeChar);
  $.add$1($.window().get$on().get$keyDown(), $.onKeyDown);
};
...
$.StateMachine$bailout = function(state, env0, env1, env2, env3) {
  switch (state) {
    case 1:
      var event$ = env0;
      textElement = env1;
  ...
  switch (state) {
    ...
    case 1:
      state = 0;
    default:
      if (state == 2 || state == 3 || state == 4 || state == 5 || state == 6 || state == 7 || state == 8 || state == 9 || state == 10 || state == 11 || state == 12 || state == 13 || state == 14 || state == 15 || state == 16 || state == 17 || state == 18 || state == 19 || state == 20 || state == 21 || state == 22 || state == 23 || state == 24 || state == 25 || state == 26 || state == 27 || state == 28 || state == 29 || state == 30 || state == 31 || state == 32 || state == 33 || state == 34 || state == 35 || state == 36 || state == 37 || state == 38 || state == 39 || (state == 0 && $.eqB(t1, 13))) {
        switch (state) {
          case 0:
            t1 = $.counter;
          case 2:
          ...
          case 3:
            state = 0;
          default:
            if (state == 4 || state == 5 || state == 6 || state == 7 || state == 8 || state == 9 || state == 10 || state == 11 || state == 12 || state == 13 || state == 14 || state == 15 || state == 16 || state == 17 || state == 18 || state == 19 || state == 20 || state == 21 || state == 22 || state == 23 || state == 24 || state == 25 || state == 26 || state == 27 || state == 28 || state == 29 || state == 30 || state == 31 || state == 32 || state == 33 || state == 34 || state == 35 || state == 36 || state == 37 || state == 38 || state == 39 || (state == 0 && $.ltB(t1, $.sub(t3, 1)))) {
              switch (state) {
                case 0:
                  t1 = $.counter;
                case 4:
                ...
                case 5:
                  state = 0;
                  t3 = $.index(t1, $.counter).get$sType();
                case 6:
                  state = 0;
                default:
                  if (state == 7 || state == 8 || (state == 0 && $.eqB(t3, 0))) {
                    switch (state) {
                      case 0:
                        $.query('#nameInpt').set$hidden(true);
                        $.query('#comingInpt').set$hidden(true);
                    ...
                    switch (state) {
                      ...
                      case 10:
                        state = 0;
                      default:
                        if (state == 11 || state == 12 || state == 13 || (state == 0 && $.eqB(t3, 1))) {
                          switch (state) {
                            case 0:
                              t1 = $.isWriting;
                            case 11:
                              state = 0;
                            default:
                              if (state == 12 || state == 13 || (state == 0 && $.eqB(t1, true))) {
                                switch (state) {
                                  case 0:
                                    $.isWriting = false;
                                    $.writingCounter = 2000;
                                  ...
                                  case 13:
                                    state = 0;
                                    textElement.set$text($.index(t1, $.sub(t3, 1)).get$textValue());
                                }
                              } else {
                                $.StateMachine(event$);
                              }
                          ...
                          switch (state) {
                            ...
                            case 15:
                              state = 0;
                            default:
                              if (state == 16 || (state == 0 && $.eqB(t3, 2))) {
                                switch (state) {
                                  case 0:
                                    t1 = $.state.get$stateMap();
                                  case 16:
                                    state = 0;
                                    $.query($.index(t1, $.counter).get$name()).set$hidden(false);
                                }
                              } else {
                                switch (state) {
                                  case 0:
                                  ...
                                  case 18:
                                    state = 0;
                                  default:
                                    if (state == 19 || state == 20 || state == 21 || state == 22 || state == 23 || state == 24 || state == 25 || state == 26 || state == 27 || state == 28 || state == 29 || state == 30 || state == 31 || state == 32 || state == 33 || state == 34 || state == 35 || state == 36 || state == 37 || state == 38 || state == 39 || (state == 0 && $.eqB(t3, 3))) {
                                      switch (state) {
                                        case 0:
                                          t1 = $.state.get$stateMap();
                                        case 19:
                                        ...
                                        case 20:
                                          state = 0;
                                        default:
                                          if (state == 21 || state == 22 || (state == 0 && !$.eqB(t3, 'EntryNameValidation'))) {
                                            switch (state) {
                                              case 0:
                                                t1 = $.state.get$stateMap();
                                              case 21:
                                          ...
                                          if (state == 23 || state == 24 || state == 25 || state == 26 || (state == 0 && t1)) {
                                            ...
                                            switch (state) {
                                              ...
                                              case 28:
                                                state = 0;
                                              default:
                                                if (state == 29 || (state == 0 && $.eqB(t3, 'EntryValQuestion'))) {
                                                  switch (state) {
                                                    case 0:
                                                      t1 = $.query('#Memory').get$value();
                                                    case 29:
                                                  ...
                                                  switch (state) {
                                                    ...
                                                    case 31:
                                                      state = 0;
                                                    default:
                                                      if (state == 32 || (state == 0 && $.eqB(t3, 'ComingValidation'))) {
                                                        switch (state) {
                                                          case 0:
                                                            t1 = $.query('#NoComing').get$checked();
                                                          case 32:
                                                        ...
                                                        switch (state) {
                                                          ...
                                                          case 34:
                                                            state = 0;
                                                          default:
                                                            if (state == 35 || (state == 0 && $.eqB(t3, 'Plus1Validation'))) {
                                                              switch (state) {
                                                                case 0:
                                                                  t1 = $.query('#NoGuest').get$checked();
                                                                case 35:
                                                              ...
                                                              switch (state) {
                                                                ...
                                                                case 37:
                                                                  state = 0;
                                                                case 38:
                                                                  if (state == 38 || (state == 0 && $.eqB(t3, 'EntryDinnerValidation'))) {
                                                                    switch (state) {
                                                                      case 0:
                                                                        t1 = $.query('#NoGuest').get$checked();
                                                                      case 38:
...
$.writeChar$bailout = function(state, env0, env1, env2) {
  switch (state) {
    case 1:
      t1 = env0;
      break;
  ...
  switch (state) {
    ...
    case 1:
      state = 0;
      var s = $.index(t1, $.counter).get$textValue();
      t1 = $.writingCounter;
    case 2:
      state = 0;
      var t3 = $.get$length(s);
    case 3:
      state = 0;
    default:
      if (state == 4 || state == 5 || (state == 0 && $.ltB(t1, t3))) {
        switch (state) {
          case 0:
            t1 = $.state.get$stateMap();
          case 4:
    ...
    case 7:
      if (state == 6 || state == 7 || (state == 0 && t1)) {
        switch (state) {
          ...
          case 6:
            state = 0;
            textElement.set$text($.substring$2(s, 0, $.add(t1, 1)));
            t3 = $.writingCounter;
          case 7:
            state = 0;
            $.writingCounter = $.add(t3, 1);
            $._TimerFactory_Timer($.writingSpeed, $.writeChar);
        }
      } else {
        $.isWriting = false;
...
$.writeChar.$call$1 = $.writeChar;
$.writeChar.$name = "writeChar";
...
$.$defineNativeClass('Element', ["style?", "id?", "hidden!"], {
 $dom_querySelector$1: function(selectors) {
  return this.querySelector(selectors);
 },
 get$on: function() {
...
$.$defineNativeClass('HTMLInputElement', ["value=", "pattern?", "name?", "checked?"], {
 get$on: function() {
